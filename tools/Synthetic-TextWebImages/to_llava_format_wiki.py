...
DATA_PATH = "./dataset/Synthetic-TextWebImages/wikipedia-22-12-ja-embeddings"
...
if __name__ == "__main__":
    ...
    dataset = load_dataset("team-hatakeyama-phase2/Synthetic-TextWebImages", "wikipedia-22-12-ja-embeddings", cache_dir="./cache")
