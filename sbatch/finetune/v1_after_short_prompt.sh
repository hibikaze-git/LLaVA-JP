...
bash scripts/finetune/finetune_accelerate.sh \
    ...
    ./configs/dataset/v1_stage_2_after_short_prompt.json \
    ./configs/model/tanuki-8b.json \
    ./output_llava/checkpoints/finetune-llava-jp-Tanuki-8B-vision-v1_after_short_prompt \
    llava-jp-stage2 \
    Tanuki-8B-vision-v1_after_short_prompt \
